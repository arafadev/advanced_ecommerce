    ...
    <section class="pt-5">
        ...
        <div class="row">
            <div class="col-md-4 mb-4 mb-md-0"><a class="category-item"
                    href="{{ route('frontend.product', $product_categories[0]->slug) }}"><img class="img-fluid"
            ...
            <div class="col-md-4 mb-4 mb-md-0"><a class="category-item mb-4"
                    href="{{ route('frontend.product', $product_categories[1]->slug) }}"><img class="img-fluid"
                        src="{{ asset('assets/product_categories/cat-img-2.jpg') }}" alt=""><strong
                    ...
                    href="{{ route('frontend.product', $product_categories[2]->slug) }}"><img class="img-fluid"
                        src="{{ asset('assets/product_categories/cat-img-3.jpg') }}" alt=""><strong
                        class="category-item-title">Watches</strong></a></div>
            <div class="col-md-4"><a class="category-item"
                    href="{{ route('frontend.product', $product_categories[3]->slug) }}"><img class="img-fluid"
                        src="{{ asset('assets/product_categories/cat-img-4.jpg') }}" alt=""><strong
