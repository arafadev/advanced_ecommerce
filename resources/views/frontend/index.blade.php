...
@section('content')
    ...
    <section class="pt-5">
        ...
        <div class="row">
            <div class="col-md-4 mb-4 mb-md-0"><a class="category-item" href="{{ route('frontend.product', $product_categories[0]->slug) }}"><img class="img-fluid"
                        src="{{ asset('assets/product_categories/cat-img-1.jpg') }}" alt=""><strong
                        class="category-item-title">Clothes</strong></a>
            </div>
            <div class="col-md-4 mb-4 mb-md-0"><a class="category-item mb-4" href="{{ route('frontend.product', $product_categories[1]->slug) }}"><img class="img-fluid"
                        src="{{ asset('assets/product_categories/cat-img-2.jpg')}}" alt=""><strong class="category-item-title">Shoes</strong></a><a
                    class="category-item" href="{{ route('frontend.product', $product_categories[2]->slug) }}"><img class="img-fluid" src="{{asset('assets/product_categories/cat-img-3.jpg')}}"
                        alt=""><strong class="category-item-title">Watches</strong></a></div>
            <div class="col-md-4"><a class="category-item" href="{{ route('frontend.product', $product_categories[3]->slug) }}"><img class="img-fluid" src="{{ asset('assets/product_categories/cat-img-4.jpg')}}"
                        alt=""><strong class="category-item-title">Electronics</strong></a></div>
        </div>
    </section>
    <!-- TRENDING PRODUCTS-->
    <section class="py-5">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="product text-center">
                    <div class="position-relative mb-3">
                        <div class="badge text-white badge-primary">Sale</div><a class="d-block" href="detail.html"><img
